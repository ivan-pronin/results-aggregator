package sportmonks.core.data.structure;

import com.fasterxml.jackson.annotation.*;
import sportmonks.core.data.entity.*;
import sportmonks.core.data.entity.StatsGoals;
import sportmonks.core.data.entity.StatsShots;
